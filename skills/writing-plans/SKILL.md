...
> **For agentic workers:** REQUIRED SUB-SKILL: Use zeropowers:subagent-driven-development (recommended) or zeropowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.
...
**"Plan complete and saved to `docs/zeropowers/plans/<filename>.md`. Two execution options:**
