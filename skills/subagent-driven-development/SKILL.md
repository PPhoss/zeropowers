...
[Read plan file once: docs/zeropowers/plans/feature-plan.md]
...
You: "User level (~/.config/zeropowers/hooks/)"
...
- **zeropowers:test-driven-development** - Subagents follow TDD for each task
