...
#   ./run-test.sh svelte-todo --plugin-dir /path/to/zeropowers
...
TIMESTAMP=$(date +%s)
OUTPUT_BASE="/tmp/zeropowers-tests/$TIMESTAMP/subagent-driven-development"
...
PROMPT="Execute this plan using zeropowers:subagent-driven-development. The plan is at: $PLAN_PATH"
