...
#   $OPENCODE_CONFIG_DIR/zeropowers/             ← package root
#   $OPENCODE_CONFIG_DIR/zeropowers/skills/      ← skills dir (../../skills from plugin)
#   $OPENCODE_CONFIG_DIR/zeropowers/.opencode/plugins/zeropowers.js ← plugin file
#   $OPENCODE_CONFIG_DIR/plugins/zeropowers.js   ← symlink OpenCode reads

SUPERPOWERS_DIR="$OPENCODE_CONFIG_DIR/zeropowers"
ZEROPOWERS_SKILLS_DIR="$SUPERPOWERS_DIR/skills"
SUPERPOWERS_PLUGIN_FILE="$SUPERPOWERS_DIR/.opencode/plugins/zeropowers.js"
...
cp "$REPO_ROOT/.opencode/plugins/zeropowers.js" "$SUPERPOWERS_PLUGIN_FILE"

# Register plugin via symlink (what OpenCode actually reads)
mkdir -p "$OPENCODE_CONFIG_DIR/plugins"
ln -sf "$SUPERPOWERS_PLUGIN_FILE" "$OPENCODE_CONFIG_DIR/plugins/zeropowers.js"
...
echo "Skills dir:           $ZEROPOWERS_SKILLS_DIR"
echo "Plugin file:          $SUPERPOWERS_PLUGIN_FILE"
echo "Plugin registered at: $OPENCODE_CONFIG_DIR/plugins/zeropowers.js"
